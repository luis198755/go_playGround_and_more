...
export function TerminalOutput({ output, isLoading, onClear }: TerminalOutputProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#0C0C0C] rounded-lg overflow-hidden border border-[#333]">
      ...
      <div 
        ref={terminalRef}
        className="flex-1 font-mono text-sm overflow-y-auto p-4"
        style={{ 
